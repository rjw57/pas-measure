...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".record-preview-image { width: 10em; }\n\n#main-content {\n  position: absolute; bottom: 0; left: 0; right: 0; top: 0;\n}\n\n#record-map { width: 100%; height: 100%; padding-right: 20em; }\n#sidebar {\n  position: absolute; right: 0; top: 0; height: 100%; width: 20em;\n  border-left: 1px solid rgb(225, 225, 232); background-color: #f7f7f9;\n}\n.record-preview-description { max-height: 10em; overflow: hidden; }\n.color-swatch {\n  width: 1em; height: 1em; background-color: #ffcc33;\n  border: 1px solid #888;\n}\n.color-swatch.pull-left { margin-right: 0.5ex; }\n.color-swatch.pull-right { margin-left: 0.5ex; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function ImageMeasure(elementId) {
	  ...
	  */
	  map.addLayer(new ol.layer.Image({
	    ...
	    source: new ol.source.ImageCanvas({
	      canvasFunction: function canvasFunction(extent, resolution, pxRato, imSize, proj) {
	        var w = imSize[0],
	            h = imSize[1];
	  ...
	  */
	  ...
	  function measurementStyleFunction(feature, resolution) {
	    ...
	    var perpPixLen = 20,
	        perpLen = resolution * perpPixLen;
	    var outerColor = 'rgba(51, 51, 51, 0.5)',
	        innerColor = '#ffcc33';
	    ...
	    var styles = [new ol.style.Style({ stroke: outerStrokeStyle, zIndex: 100 }), new ol.style.Style({ stroke: innerStrokeStyle, zIndex: 90 })];
	    ...
	    if (geometry.getType() === 'LineString') {
	      geometry.forEachSegment(function (start, end) {
	        ...
	        var perpDX = perpLen * -dy / len,
	            perpDY = perpLen * dx / len;
	
	        var perpGeom = new ol.geom.MultiLineString([[[start[0] - perpDX, start[1] - perpDY], [start[0] + perpDX, start[1] + perpDY]], [[end[0] - perpDX, end[1] - perpDY], [end[0] + perpDX, end[1] + perpDY]]]);
	
	        styles = styles.concat([new ol.style.Style({
	          geometry: perpGeom,
	          ...
	          geometry: new ol.geom.Point([0.5 * (end[0] + start[0]) + sense * 0.5 * perpDX, 0.5 * (end[1] + start[1]) + sense * 0.5 * perpDY]),
	  ...
	  self.addScale = function () {
	    ...
	    var pointerStyles = [new ol.style.Style({
	...
	function imageMeasure(elementId) {
	  return new ImageMeasure(elementId);
	}
	...
	function setCurrentRecord(record) {
	  ...
	  if (currentRecord.imagedir && currentRecord.filename) {
	    imageUrl = 'https://finds.org.uk/' + currentRecord.imagedir + '/' + currentRecord.filename;
	...
	function setDatabaseRecordModalPreview(record, isLoading, error) {
	  // Render template
	  var props = { record: record, isLoading: isLoading, error: error };
	  console.log(props);
	  ReactDOM.render(React.createElement(C.RecordPreview, props), $('#database-record-modal-preview').get(0));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.RecordPreview = function (props) {
	  return React.createElement(
	    'div',
	    { className: 'record-preview' },
	    props.error ? React.createElement(_ErrorAlert, { error: props.error }) : null,
	    props.record ? React.createElement(_RecordPreviewBody, props.record) : null,
	    props.isLoading ? React.createElement(_LoadingThrobber, null) : null,
	    !props.record ? React.createElement(
	      'p',
	      null,
	      'Enter a database URL or ID to see a preview of the record.'
	    ) : null
	  );
	};
	...
	var _ErrorAlert = function _ErrorAlert(props) {
	  return React.createElement(
	    'div',
	    ...
	    React.createElement(
	      'strong',
	      null,
	      'Cannot load that record.'
	    ),
	    ' The PAS database responded with "',
	    props.error.status,
	    ': ',
	...
	var _NoImageAlert = function _NoImageAlert(props) {
	  return React.createElement(
	    'div',
	    { className: 'alert alert-danger', role: 'alert' },
	    React.createElement(
	      'strong',
	      null,
	      'This record has no image associated with it.'
	    ),
	    ' Records must have associated images.'
	  );
	};
	
	var _RecordPreviewBody = function _RecordPreviewBody(props) {
	  return React.createElement(
	    'div',
	    { className: 'record-preview-body' },
	    !props.filename ? React.createElement(_NoImageAlert, null) : null,
	    React.createElement(
	      'div',
	      { className: 'media' },
	      props.filename ? React.createElement(
	        'div',
	        { className: 'media-left' },
	        React.createElement(
	          'div',
	          { className: 'record-preview-image media-object' },
	          React.createElement('img', { className: 'img-responsive img-thumbnail',
	      ...
	      React.createElement(
	        ...
	        props.type ? React.createElement(
	          'h4',
	          { className: 'media-heading' },
	          props.type
	        ) : null,
	        React.createElement('div', { className: 'record-preview-description',
	...
	var _LoadingThrobber = function _LoadingThrobber(props) {
	  return React.createElement(
	    'p',
